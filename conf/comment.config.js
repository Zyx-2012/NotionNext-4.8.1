...
module.exports = {
  ...
  COMMENT_UTTERRANCES_REPO:
    ...
    COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'Zyx-2012/giscus', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
    COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDONakT9A', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
    COMMENT_GISCUS_CATEGORY_ID:
        process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDONakT9M4ClCJh', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
