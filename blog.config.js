...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个爱折腾的笨蛋,Hi，你也喜欢玩Minecraft嘛,H，你知道瓜瓜是谁嘛？,Hi，听说站长还单身呢',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'DWIND', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '爱折腾的笨蛋', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.dwind.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,麦块华域,华域,晖风', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'dreamsfield@outlook.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/dreamsfield', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/DreamsField', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://s2.loli.net/2024/02/07/TgtmCy9SYoKBIGv.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20236396号', // 备案号 闽ICP备XXXXXXX
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '由笨蛋搭建的站点', // 站点描述，被notion中的页面描述覆盖
