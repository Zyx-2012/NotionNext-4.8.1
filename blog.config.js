...
const BLOG = {
    ...
    NOTION_PAGE_ID:
      ...
      '14f4957b7a2880de9ca2c5308ad964ab',
    ...
    APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [18, 6], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式
      ...
      AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Zyx', // 您的昵称 例如 tangly1024
      BIO: process.env.NEXT_PUBLIC_BIO || '一个热爱编程的人', // 作者简介
      LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog-of-zyx.zeabur.app', // 网站地址
    ...
    // 欢迎语打字效果,Hexo,Matery主题支持, 英文逗号隔开多个欢迎语。
      GREETING_WORDS:
          ...
          'Hi，我是Zyx, Hi，我是一个小学生,Hi，我是一个热爱编程的人,欢迎来到我的博客!',
